...
<div class="lockscreen-wrapper">
    ...
    <div class="lockscreen-logo">
        <a href="{{ $dashboard_url }}">
            <img src="{{ url(config('adminlte.logo_img')) }}" height="50">
    ...
    <div class="lockscreen-item">
        ...
        <form method="POST" action="{{ route('password.confirm') }}" class="lockscreen-credentials @if(!config('adminlte.usermenu_image'))ml-0 @endif">
            ...
            <div class="input-group">
                <input id="password" type="password" name="password" class="form-control @error('password') is-invalid @enderror" placeholder="{{ __('adminlte::adminlte.password') }}" required autofocus>
